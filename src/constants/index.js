  ...
  export const myProjects = [
    {
      ...
      href: 'https://github.com/psbrar2002/IEQ-Project',
    ...
    {
      title: 'Discord Clone',
      desc: "Discord Clone is a real-time messaging web application that replicates the core features of Discord, allowing users to seamlessly send messages, emojis, files, and links. Built for real-time collaboration, it offers a robust user experience with instant message delivery and real-time updates.",
      subdesc:
        "By leveraging Firebase for backend services, including authentication and real-time data management, and utilizing Redux for efficient state handling, this app ensures a smooth and responsive user experience. Google and Anonymous authentication options enhance accessibility, making it easy for anyone to connect and communicate in real time.",
      href: 'https://github.com/psbrar2002/discord_clone',
      texture: '/textures/project/project2.mp4',
      logo: '/assets/discord.webp',
      logoStyle: {
